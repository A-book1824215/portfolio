# Neoyuki Dev — ポートフォリオサイト

業務自動化・小規模Webシステム制作を行う「ネオユキ」のポートフォリオサイトです。

**公開URL**: https://a-book1824215.github.io/portfolio/
...
- ホスティング: GitHub Pages
- CSV整形ツール・IME顔文字辞書メーカーなどはすべてブラウザ内で処理（データはサーバーに送信されません）
- アクセシビリティ配慮: WCAG AA準拠のコントラスト比、フォーカスリング、スキップナビゲーション

## お問い合わせ

サイト内の[お問い合わせフォーム](https://a-book1824215.github.io/portfolio/#contact)からお願いします。
